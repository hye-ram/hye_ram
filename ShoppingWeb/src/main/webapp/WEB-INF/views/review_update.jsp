...
<body class="sub_page">
	...
	<script>
						...
						function() {
							...
							$("#btnDelete")
									.click(
											function() {
												if (confirm("삭제하시겠습니까?")) {
													document.form3.action = "${path}/shoppingweb/review_delete";
							...
							$("#btnUpdete")
									.click(
											function() {
												...
												if (title == "") {
													alert("제목을 입력하세요");
													document.form2.title
															.focus();
													return;
												}
												if (writer == "") {
													alert("이름을 입력하세요");
													document.form2.writer
															.focus();
													return;
												}
												document.form3.action = "${path}/shoppingweb/review_update"
												// 폼에 입력한 데이터를 서버로 전송
												document.form3.submit();
											});
	    ...
	    function listReply(){
	        $.ajax({
	            type: "get",
	            url: "${path}/shoppingweb/reply_list?bno=${dto.bno}",
