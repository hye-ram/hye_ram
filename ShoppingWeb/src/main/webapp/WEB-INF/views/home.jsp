...
<body class="main_page">
	...
	<section class=" slider_section position-relative">
							...
							<div class="d-flex  flex-column flex-lg-row align-items-center">
								<ul class="navbar-nav  ">
									...
									<li class="nav-item"><a class="nav-link"
										href="javascript:void(0);" id="review" onclick="getBoardId()">Review
									</a></li>
									<li class="nav-item"><a class="nav-link">Notice</a></li>
		...
		<!-- end nav section -->
		<div
			style="width: 100px; height: 100px; border: 1px solid red; position: absolute; z-index: 1000;"
			id="notice"></div>
		...
		<script>
			$('#notice').click(function() {
				alert($(this).attr("id"));
				$.ajax({
					url : "${pageContext.request.contextPath}/goBoard",
					type : "GET",
					data : {
